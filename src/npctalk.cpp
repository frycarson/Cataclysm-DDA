...
void game::init_npctalk()
{
    ...
    for(int j = 0; j < 10; j++) {
        talk_bad_names[j] = tmp_talk_bad_names[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_good_names[j] = tmp_talk_good_names[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_swear_interjection[j] = tmp_talk_swear_interjection[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_fuck_you[j] = tmp_talk_fuck_you[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_really[j] = tmp_talk_really[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_greeting_gen[j] = tmp_talk_greeting_gen[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_ill_die[j] = tmp_talk_ill_die[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_ill_kill_you[j] = tmp_talk_ill_kill_you[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_drop_weapon[j] = tmp_talk_drop_weapon[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_hands_up[j] = tmp_talk_hands_up[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_no_faction[j] = tmp_talk_no_faction[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_come_here[j] = tmp_talk_come_here[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_keep_up[j] = tmp_talk_keep_up[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_let_me_pass[j] = tmp_talk_let_me_pass[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_done_mugging[j] = tmp_talk_done_mugging[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_leaving[j] = tmp_talk_leaving[j];
    }
    ...
    for(int j = 0; j < 10; j++) {
        talk_catch_up[j] = tmp_talk_catch_up[j];
    }
}
...
std::vector<talk_response> gen_responses(talk_topic topic, npc *p)
{
    ...
    case TALK_TRAIN: {
        ...
        for (int i = shift; i < trainable.size() && printed < 9; i++) {
            ...
            SELECT_SKIL(
                string_format(_("%s: %d -> %d (cost %d)"), trained->name().c_str(),
